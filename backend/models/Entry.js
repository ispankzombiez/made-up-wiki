...
class Entry {
  static async create(word, partOfSpeech, pronunciation, definition, example, relatedWords, categories, createdBy) {
    const result = await db.query(
      'INSERT INTO entries (word, part_of_speech, pronunciation, definition, example, related_words, categories, created_by) VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING id, word, part_of_speech, pronunciation, definition, example, related_words, categories, created_by, created_at, updated_at',
